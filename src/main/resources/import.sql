...
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, data_de_criacao, acao, ativo) VALUES (1, 'Dryfit', 'Alumínio', 'Coltex', 100, '2021-01-01T03:45:00', 'CRIADO', true);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, data_de_criacao, acao, ativo) VALUES (2, 'Dryfit', 'Preto', 'Coltex', 100, '2021-01-01', 'CRIADO', true);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, data_de_criacao, acao, ativo) VALUES (3, 'Dryfit', 'Branco', 'Coltex', 100, '2021-01-01', 'CRIADO', true);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, data_de_criacao, acao, ativo) VALUES (4, 'Dryfit', 'Amarelo', 'Coltex', 100, '2021-01-01', 'CRIADO', true);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, data_de_criacao, acao, ativo) VALUES (5, 'Dryfit', 'Azul', 'Coltex', 100, '2021-01-01', 'CRIADO', true);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, data_de_criacao, acao, ativo) VALUES (6, 'Dryfit', 'Vermelho', 'Coltex', 100, '2021-01-01', 'CRIADO', true);
