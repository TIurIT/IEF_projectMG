...
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, rendimento, data_de_criacao, acao, ativo, favorito) VALUES (1, 'Dryfit', 'Alumínio', 'Coltex', 16.4, 5.4, '2021-01-01T03:45:00', 'CRIADO', true, false);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, rendimento, data_de_criacao, acao, ativo, favorito) VALUES (2, 'Dryfit', 'Preto', 'Coltex', 12.5, 5.4, '2021-01-01', 'CRIADO', true, false);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, rendimento, data_de_criacao, acao, ativo, favorito) VALUES (3, 'Dryfit', 'Branco', 'Coltex', 20.85, 5.4, '2021-01-01', 'CRIADO', true, false);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, rendimento, data_de_criacao, acao, ativo, favorito) VALUES (4, 'Dryfit', 'Amarelo', 'Coltex', 39.2, 5.4, '2021-01-01', 'CRIADO', true, false);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, rendimento, data_de_criacao, acao, ativo, favorito) VALUES (5, 'Dryfit', 'Azul', 'Coltex', 13.6, 5.4, '2021-01-01', 'CRIADO', true, false);
INSERT INTO tb_estoque_material (id, tipo, nome, fornecedor, quantidade, rendimento, data_de_criacao, acao, ativo, favorito) VALUES (6, 'Dryfit', 'Vermelho', 'Coltex', 11.7, 5.4, '2021-01-01', 'CRIADO', true, false);
